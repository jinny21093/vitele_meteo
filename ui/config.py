...
# только через ZeroTier», тот же ТЗ §2.3). Каждый адрес — свой слушатель,
# семафор соединений общий. Порт 8089; занят -> 8091 (патч ТЗ v1.2.3 §12.3:
# 8090 занят weather-api этапа B; решение установщика — server.py только
