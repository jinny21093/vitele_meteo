...
/* weather-ui app.js — общий клиентский слой (ТЗ weather-ui-spec.md §6).
   ...
   v0.5.0 — U6 «Настройки»: UI_VERSION 0.5.0 (новый экран = minor, §4.0).
   app.js функционально НЕ меняется: навигация уже содержит «Настройки» (U0),
   хелперы apiFetch/el/poll/fmt* переиспользованы page-settings.js как есть
   (кроме UI_VERSION правок нет — обоснование бампа в шапке, U6-правила).
...
window.WEATHER = (function () {
  const UI_VERSION = "0.5.0";          // U0-U6 (semver, §4.0)
