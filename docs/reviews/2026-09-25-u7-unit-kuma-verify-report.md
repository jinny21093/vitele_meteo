...
Тест падения (два окна остановки UI — **предупреждение владельцу: контролируемый простой UI в 00:14–00:30 MSK, фактический суммарный интервал 7 мин 06 с по journalctl**; досдача Б3: stop 00:14:12 → start 00:17:45 = 3 мин 33 с; stop 00:22:26 → start 00:25:58 = 3 мин 32 с; плюс 1 с — рестарт после kill -9 в 00:29:43–00:29:44):
...
4. Простой UI при тестах — фактический суммарный **7 мин 06 с** в окне 00:14–01:00 MSK (journalctl: ровно 3 окна — 3 мин 33 с + 3 мин 32 с + 1 с; досдача Б3 исправляет ранее заявленные «~12 мин» — окно 00:14–01:00 больше остановок не содержит; все старты/остановки — через штатный systemctl, юнит каждый раз возвращался в active).
